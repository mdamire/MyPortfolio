...
class ToolsContent:
    ...
    def __init__(self, resource_container=None):
        self.content_list = []
        self.resource_container = resource_container
        self.structured_content = None

    def add_text(self, text: str, annotations: Optional[Dict[str, Any]] = None):
        """Add text content."""
    ...
    def add_file(self, file: str, annotations: Optional[Dict[str, Any]] = None):

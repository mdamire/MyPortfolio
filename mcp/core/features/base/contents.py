...
class MimeTypes:
    ...
    class Audio(Enum, MimeTypeMapper):
        WAV = "audio/wav"
        MP3 = "audio/mpeg"
        AAC = "audio/aac"
        OGG = "audio/ogg"
    ...
    class Text(Enum, MimeTypeMapper):
        PLAIN = "text/plain"
        HTML = "text/html"
        CSS = "text/css"
...
class BinaryContentSanitizer:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #     raise ValueError(
        #         "Either 'file' must be provided, or both 'data' and 'mime_type' must be provided"
        #     )
...
class TextContentSanitizer:
    _mime_type_mapper_class = MimeTypes.Text

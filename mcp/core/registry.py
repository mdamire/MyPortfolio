...
from .features.tools.container import ToolsContainer
...
class MCPRegistry:
    ...
    # def add_prompt(self, func, name=None, title=None, description=None):
    #     return self._get_prompt_container().add_prompt(func, name=name, title=title, description=description)
